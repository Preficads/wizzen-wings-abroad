        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              ...
              <br />
              <span className="text-primary">Dreams with Wizzen Overseas</span>
            </h1>

            {/* Description */}
            <p className="text-lg md:text-xl text-muted-foreground max-w-lg leading-relaxed">
              Your trusted partner for a seamless immigration journey to Europe. 
              From visa processing to university enrollment, we guide you every 
              step of the way.
            </p>
          ...
          <div className="relative animate-slide-in">
            <div className="relative">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -left-4 bg-accent text-accent-foreground px-4 py-2 rounded-full text-sm font-medium shadow-soft animate-float">
                🇩🇪 German Visa Expert
              </div>
              <div className="absolute -bottom-4 -right-4 bg-primary text-primary-foreground px-4 py-2 rounded-full text-sm font-medium shadow-warm animate-float" style={{animationDelay: '1s'}}>
                Study in Europe
              </div>
              
              {/* Rating Badge */}
              <div className="absolute top-8 -right-8 bg-background border border-border p-4 rounded-2xl shadow-soft">
                ...
                <div className="text-xs text-muted-foreground">900+ Reviews</div>
              </div>
            </div>
          </div>
        </div>
