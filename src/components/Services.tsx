...
// ✅ Detailed Descriptions (now in cards with header on top-left)
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 mx-auto max-w-[75%] px-4 sm:px-6 lg:px-8">
        ...
        {/* Detailed Section in Cards (Header shifted to top-left) */}
        <div className="mt-80 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {detailedServices.map((item, idx) => {
            ...
            return (
              ...
              >
                <Card
                  className="h-[200PX] bg-[#ffffff] backdrop-blur-2xl border border-white/20 
                             rounded-2xl shadow-lg hover:scale-110 border-black-400/50 
