      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        ...
        <div className="hidden lg:flex lg:gap-x-8">
          {navigation.map((item) => (
            ...
            >
              {item.name}
              <span className="absolute inset-x-0 -bottom-1 h-0.5 bg-gradient-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </a>
          ))}
        </div>
